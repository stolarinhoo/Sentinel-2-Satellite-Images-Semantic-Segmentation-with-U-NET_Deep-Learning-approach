...
def prepare_datasets(batch_size, train_size, images_dir, labels_dir):
    (train_image_paths, val_image_paths, test_image_paths,
     train_label_paths, val_label_paths, test_label_paths) = (
        __split_data_for_training_testing_and_validation(train_size, images_dir, labels_dir))
...
def __split_data_for_training_testing_and_validation(test_size, images_dir, labels_dir):
...
def __train_test_split_paths(image_paths, label_paths, train_size):  
...
def __create_tf_datasets(image_paths, label_paths):
...
def __load_and_preprocess(image_path, label_path):
